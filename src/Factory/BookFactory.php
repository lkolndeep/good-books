 ...
 * @method static Book|Proxy                     find(array|mixed|object $criteria)
...
{
    private const BOOK_TITLES = ['Les fruits et légumes', 'Des vacances au soleil', 'Bienvenue au Danemark', 'Rendez vous à New York'];
    private const AUTHOR_NAMES = ['Jonathan Hotkinson', 'Pierre Nicholson', 'Jean Richard', 'Marc Fletcher'];
    ...
    {
        return [
            'author' => self::faker()->randomElement(self::AUTHOR_NAMES),
            'lent' => self::faker()->boolean(),
            'owner' => self::faker()->text(255),
            'title' => self::faker()->randomElement(self::BOOK_TITLES),
        ];
    }
